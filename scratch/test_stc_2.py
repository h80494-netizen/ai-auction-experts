...
async def main():
    async with async_playwright() as p:
        ...
        try:
            ...
            with open("scratch/search_result_stc_2.html", "w", encoding="utf-8") as f:
                f.write(html)
            await page.screenshot(path="scratch/search_result_stc_2.png")
            print("Saved result page to scratch/search_result_stc_2.html and scratch/search_result_stc_2.png")
