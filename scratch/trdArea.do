...
<!--  -->
<link rel="stylesheet" type="text/css" href="../../../pubcss/common/layout.css">
<!--  -->
...
<link rel="stylesheet" type="text/css" href="../../../pubcss/map/trdarea/trdarea.css?ver=202604080000">
<script src="../../../js/map/trdarea/trdarea.js?ver=202604090000"></script>
</head>
<!-- 구글 애널리틱스 -->
<!-- favicon link -->
	...
	<script>
		...
		$(document).ready(function() {
			...
			if(mbrId == '' || mbrId == null || mbrId == 'undefined') {				
				...
				leftMenuUI.setMenu(roleCd,2,authCd);
			}
		});
	</script>
		...
		<div class="side-wrap">
			...
			<div class="side-content-wrap">
				...
				<div>
					...
					<!-- 행정구역 -->
					<div class="subtext">행정구역 선택</div>
					<div class="selectarea">
						<div>행정구역</div>
						<div>
							<select id="sglist"><option>자치시군</option></select> <select
								id="sgdlist"><option>행정읍면동</option></select>
						</div>
					</div>
					<!-- 선택조건 -->
					<div class="select-wrap">
						<div class="box" id="selchoice">
							<div>
								기준분기 <select id="selectYear"><option>2021년</option></select><select
									id="selectQu"><option>3분기</option></select>
							</div>
							<div class="checkbox-group">
								<label><input type="checkbox"
									onchange="checkboxLimitCheck(this, 3);"> 매출</label> <label><input
									type="checkbox" onchange="checkboxLimitCheck(this, 3);">
									직장인구</label> <label><input type="checkbox"
									onchange="checkboxLimitCheck(this, 3);"> 상존인구</label> <label><input
									type="checkbox" onchange="checkboxLimitCheck(this, 3);" checked>
									점포수</label> <label><input type="checkbox"
									onchange="checkboxLimitCheck(this, 3);"> 주거인구</label> <label><input
									type="checkbox" onchange="checkboxLimitCheck(this, 3);">
									평균영업기간</label>
							</div>
							<div>최대 3개 선택</div>
						...
						<div class="choice">
							<label>선택조건</label> 선택 항목 기준 상위 10%
							<div onclick="Doc.btnChoiceSlide(this, '#selchoice')">▼</div>
						</div>

					</div>
					<!-- 검색하기 -->
					<div class="searchbutton" onclick="Doc.btnSearch()">
						<img src="../../../images/map/ic_search_white.png">상권검색
					</div>
					<div class="searchbutton analysisbutton" style="display: none;"
						onclick="Doc.btnAnalysis()">분석하기</div>

					<!-- 검색결과 -->
					<div class="result" id="resultbox">
						<div class="result-wrap" id="resultcontent">
							<div class="tab-wrap" id="rtabs">
								<div
									onclick="ReportUI.tabselected(this, '#rtabs', '#rtabcontents')"
									class="tabselected">전체</div>
								<div
									onclick="ReportUI.tabselected(this, '#rtabs', '#rtabcontents')">
									발달</div>
							...
							<div class="tab-content-wrap" id="rtabcontents">
								<span>분석할 상권을 선택하세요</span>
								<div style="display: block;">
									<div class="text">검색 결과가 존재하지 않습니다</div>
									<div class="tab-content-trd"></div>
									<div class="text">검색 결과가 존재하지 않습니다</div>
									<div class="tab-content-trd"></div>
									<div class="text">검색 결과가 존재하지 않습니다</div>
									<div class="tab-content-trd"></div>
						...
						<div class="button-wrap">
							<div onclick="Doc.btnAnalysis()">분석하기</div>
							<div onclick="Doc.btnResultClose('#resultbox');">닫기 ▲</div>
						</div> -->
							<div class="button-wrap">
								<div class="analysis" onclick="Doc.btnAnalysis()">상권 분석하기</div>
								<div class="close" onclick="Doc.btnResultClose('#resultbox');">닫기
									▲</div>
							</div>
						</div>
					</div>
					...
					<!-- 					분석영역 보관함 -->
					<!-- 					<div class="areakeeptitle">지도에서 상권 영역을 추가해 주세요(최대3개)</div> -->
					<!-- 					<div class="areakeep"> -->
					...
					<!-- 					상권비교 -->
					<!-- 					<div class="storecompare" onclick="Doc.btnCompareReport()">상권영역 비교분석하기</div> -->
					...
					<div class="tabs">
						<input id="tab1" type="radio" name="tab_item" checked> <label
							class="tab_item" for="tab1">상권비교</label>
						<div class="tab_content" id="tab1_content">
							<!-- 업종영역 -->
							<div class="subtext areakeeptitle">지도에서 상권 영역을 추가해
								주세요(최대3개)</div>
							<div class="induarea-wrap">
								...
								<div class="storecompare" onclick="Doc.btnCompareReport()">상권영역
									비교분석하기</div>
								<!--알림 문구 -->
								<div class="notice">
									<label>동일업종</label>으로 상권비교가 가능합니다
...
<!-- 사용자 메뉴 : end -->
			...
			<!-- 보고서 layer -->
			<div class="report-wrap multi"
				style="display: none; height: 80%; min-height: 60px;"
				id="reportlayer">
				<div class="report-logo">
					<img src="../../../images/map/ic_report_compare.png">경기 상권 분석
				</div>
			...
			<!-- 상권비교분석보고서 -->
			<div style="height: 584px; display: none;" class="report-wrap single"
				id="reportsinglelayer">
				<div class="report-logo">
					<img src="../../../images/map/ic_report_compare.png">경기 상권 분석
				</div>
				...
				<div class="report-singlecontent-wrap" id="reportsinglecontent">
					<div>
						<div class="report-singlecontent-top">
							<div class="report-singlecontent-tit">상권 비교 분석</div>
			...
			<div id="singlereporttabletemp" style="display: none;">
				<table>
					...
					<tbody>
						...
						<tr>
							<td>창업온도</td>
							<td><div class="report-table-temperature">
	...
	<!-- 경기 상권 분석 이용방법 -->
        <div id="pageGuideModal" class="modal_wrap modal_long page_guide_modal" style="display: none;">
            <div class="modal_box">
               ...
               <div class="modal_cont">
                    <div class="blue_title">경기상권 분석 이용방법</div>
                    <div class="page_img"><img src="../../../images/map/page_guide_trdArea.png" alt="페이지"></div>
                    <div class="page_guide_box">
                        <ul class="guide_list">
                            <li class="list">
                                <span class="number">1</span>
                                <span class="desc">위치검색 : 경기도내 주소 및 장소 검색 후 빠른 위치 이동 제공</span>
                            </li>
                            <li class="list">
                                <span class="number">2</span>
                                <span class="desc">업종선택 : 3개 대분류 서비스 및 118개 생활밀접업종 선택</span>
                            </li>
                            <li class="list">
                                <span class="number">3</span>
                                <span class="desc">조회할 행정구역 선택 : 1) 경기도 > 자치시군     2) 행정동</span>
                            </li>
                            <li class="list">
                                <span class="number">4</span>
                                <span class="desc">상권검색 클릭 후 검색된 행정구역 선택</span>
                                <span class="desc inner_desc">
                                    - 행정구역별 상권분석 지역을 선택<br>
                                    - 선택조건 검색조건 설정기능 제공
                                </span>
                            </li>
                            <li class="list">
                                <span class="number">5</span>
                                <span class="desc">검색 정보 설정 후 검색 : GIS 연동한 상권지역 이동</span>
                            </li>
                            <li class="list">
                                <span class="number">6</span>
                                <span class="desc">분석지역 선택(GIS) : GIS에서 상권영역 선택 후 분기,월간 보고서 및 상권비교 리스트 추가</span>
                            </li>
                            <li class="list">
                                <span class="number">7</span>
                                <span class="desc">상권 분석하기 : 선택 상권 분석 정보 제공(업종분석, 소비분석, 매출분석, 인구분석, 지역분석)</span>
                            </li>
                            <li class="list">
                                <span class="number">8</span>
                                <span class="desc">상권 분석 부가기능</span>
                                <span class="desc inner_desc">
                                    &#60;상권영역 GIS 아이콘&#62; 상권영역 : 주요상권(골목,발달,전통시장) 영역표출 및 상권분석 제공<br>
                                    &#60;점포이력 GIS 아이콘&#62; 점포이력 : 선택 상권 영역 내의 점포별 이력 제공<br>
                                    &#60;시설물 GIS 아이콘&#62; 선택 상권영역 내의 주요시설물 위치 및 간단정보 제공<br>
                                    &#60;상존인구(길단위) GIS 아이콘&#62; 선택 상권영역 내의 길단위 상존인구 간단정보 제공<br>
                                    &#60;상존인구(건물단위) 아이콘&#62; 선택 상권영역 내의 건물단위 상존인구 간단정보 제공<br>
                                    &#60;상권정보 히티맵 GIS 아이콘&#62; 정보별 데이터 밀도 정보를 GIS 시각화하여 제공<br>
                                    &#60;지역화폐 GIS 아이콘&#62; 선택 상권영역 내의 지역화폐 점포 위치 및 간단정보 제공<br>
                                    &#60;프랜차이즈 GIS 아이콘&#62; 선택 상권영역 내의 프랜차이즈 위치 및 간단정보 제공
                                </span>
                            </li>
                        </ul>
                    </div>
