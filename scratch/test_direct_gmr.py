...
cookies = {
    'JSESSIONID': 'E9D8E7C4101ABD32DA22CA7DE3761630.node1',
}
...
try:
    print("Testing direct query to GMR WMS...")
    ...
    if 'image' not in response.headers.get('Content-Type', ''):
        ...
        with open("scratch/direct_tile.png", "wb") as f:
            f.write(response.content)
        print("Image saved to scratch/direct_tile.png")
